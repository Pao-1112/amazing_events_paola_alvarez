...
function see_cards(cards_list, container){
  ...
  if (cards_list.length > 0){
    ...
    for (let card of cards_list){
      ...
      <div class="card p-3" style="width: 20rem; height: 28rem;"><figure class="p-2"><img src=${card.image} class="card-img-top card1_img alt="cards"></img>
    ...
    let div = document.createElement('div');
    div.innerHTML = `<h3>El evento no existe. Busque nuevamente</h3>`
